...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/usr/local/ffmpeg--enable-gpl --enable-nonfree --enable-shared --disable-ffprobe --toolchain=msvc
prefix=/usr/local/ffmpeg--enable-gpl
...
CC_IDENT=用于 x64 的 Microsoft (R) C/C++ 优化编译器 19.29.30152 版
ARCH=x86
INTRINSICS=none
EXTERN_PREFIX=
CC=cl.exe
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_USE_MATH_DEFINES -D_CRT_SECURE_NO_WARNINGS -D_CRT_NONSTDC_NO_WARNINGS -D_WIN32_WINNT=0x0600 -DPIC -I$(SRC_PATH)/compat/atomics/win32
CFLAGS= -nologo    -Z7 -W3 -wd4018 -wd4146 -wd4244 -wd4305 -wd4554 -O2   -utf-8
...
LD_PATH=-libpath:
DLLTOOL=
WINDRES=./compat/windows/mswindres
DOXYGEN=doxygen
...
EXTRALIBS-avcodec=mfuuid.lib ole32.lib strmiids.lib ole32.lib user32.lib
